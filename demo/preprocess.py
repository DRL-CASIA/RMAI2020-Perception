...
from utils.utils_mulanchor import count_parameters as count
from utils.utils_mulanchor import convert2cpu as cpu
...
def letterbox_image(img, inp_dim):
    ...
    canvas = np.full((inp_dim[1], inp_dim[0], 3), 128)  # padding过程
